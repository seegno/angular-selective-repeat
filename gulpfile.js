...
var config = {
  name: 'angular-selective-repeat.js',
  entry: './src/angular-selective-repeat.js',
  src: [
    './src/controllers/repeat-controller.js',
    './src/directives/repeat-directive.js',
    './src/directives/item-directive.js',
    './src/directives/rest-directive.js',
    './src/angular-selective-repeat.js'
  ],
  dest: './dist',
  umd: {
    namespace: 'scRepeat',
